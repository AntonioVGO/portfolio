      ...
      <div className="w-screen f-screen">
        <div className="h-full w-full bg-gray-800">
          ...
          <main className="flex flex-col justify-center w-full mt-20">
            ...
            <section className="mt-20 w-full h-full flex-row">
              <div className="flex mt-20 w-full bg-white">
                ...
                <div className="flex items-center p-10 text-justify text-xs  lg:text-base xl:text-xl">
                  <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Asperiores exercitationem impedit consequatur rem debitis, eos quibusdam animi explicabo inventore ullam eligendi aliquam incidunt facilis cupiditate laboriosam fugiat tempora. Illum, cumque.
                    <br></br><br></br>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Odit quae iure, dignissimos consequatur quo id fugit necessitatibus labore earum voluptas voluptatibus facilis officia, iusto aspernatur quasi porro modi sint similique.
                  </p>
                </div>
              </div>
          ...
          <footer className="flex flex-row content-between w-full mt-10 px-5 py-3 bg-gray-900">
            <div className="flex flex-row w-full text-white py-4 space-x-5 text-xs sm:text-xs  lg:text-base xl:text-lg">
