    ...
    return (
        ...
        <>
            ...
            <nav className={`${hidden ? "block" : "hidden"} w-full md:block md:w-auto`}>
                <ul className="opacity-95 md:opacity-100 fixed right-9 top-10 md:right-0 md:top-0 md:relative font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-gray-200 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    <li>
